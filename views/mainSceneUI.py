...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionHistorial_de_pagos = QAction(MainWindow)
        self.actionHistorial_de_pagos.setObjectName(u"actionHistorial_de_pagos")
        ...
        self.menuMenu_Clientes.addSeparator()
        self.menuMenu_Gastos_Ganancias.addAction(self.actionHistorial_de_pagos)
        self.menuMenu_Gastos_Ganancias.addSeparator()
        self.menuMenu_Gastos_Ganancias.addAction(self.actionCalcular_ganancias)
        self.menuMenu_Gastos_Ganancias.addSeparator()
        self.menuMenu_Gastos_Ganancias.addAction(self.actionIngresar_pago)
        self.menuMenu_Gastos_Ganancias.addSeparator()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionHistorial_de_pagos.setText(QCoreApplication.translate("MainWindow", u"Historial de pagos", None))
